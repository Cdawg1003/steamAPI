...
The ultimate goal is to add tables and potetial visualizations to my website in an effort to display my skills in data management, data visualization, and analytics. 
...
+ **steaReviews.py**: Similar to steamGames we use game ids to pull over 30,000 data points for the games we pulled in steamGames.py
